...
\section{Purpose}
The purpose of this thesis is to evaluate and improve the performance of the friction brake system on the \gls{rcv}. 

To fulfill the purpose a couple of research questions was set up. These are as follows: 
\begin{itemize}
%Original question: \item To what extent can braking performance in terms of actuation speed be improved with the new control method?
\item Which are the most common methods used in friction brake controllers in brake-by-wire systems and autonomous vehicles? %Change this to which of the two control methods works best?
%Göra om till jämföra två vanliga
%\item To what extent can the error in how the torque request are met be lowered with new control methods?
%Subquestions?
\item With two of the most common controllers, how does the control methods together with brake blending enhance how the torque request are met, compared to each other as well as  before?
\item Can the controllers achieve an error of a maximum of 5\% of the requested torque at all times?
%brake blending med torque fill ist
\end{itemize}

...
[CAD picture of mounts]

\section{Implementation and tuning in simulink/simscape}

The controller part of the thesis was conducted in simulink/simscape, and the following sections will describe this work

\subsection{Modelling in simscape}

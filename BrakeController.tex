...
The plant model was constructed in Simulink, mostly using the Simscape toolbox. The plant consists of a few different parts which are the hydraulic system, 
